void ClosureTest_ISprompt_HEID(){
...
TH1D* h1 = (TH1D*)f1->Get(User_ID+"/ClosureTest/ZMass_OS_CFweighted_shifted_13");
...
TCanvas* c1 = new TCanvas("c1","ZMass : OS_CFweighted_1.3% vs SS_prompt ("+User_ID+")",1000,100,900,800);
c1->Divide(1,2);
...
gr1->SetLineColor(15);
gr1->SetTitle("ZMass : OS_CFweighted_1.3% vs SS_prompt ("+User_ID+")");
...
TH1D* h3 = (TH1D*)f1->Get(User_ID+"/ClosureTest/pt1_OS_CFweighted_shifted_13");
//TH1D* h4 = (TH1D*)f1->Get(User_ID+"/ClosureTest/pt2_SS");
TH1D* h4 = (TH1D*)f1->Get(User_ID+"/ClosureTest/pt2_prmt_SS");
TH1D* h5 = (TH1D*)f1->Get(User_ID+"/ClosureTest/pt2_OS_CFweighted_shifted_13");
//TH1D* h6 = (TH1D*)f1->Get(User_ID+"/ClosureTest/MET_SS");
TH1D* h6 = (TH1D*)f1->Get(User_ID+"/ClosureTest/MET_prmt_SS");
TH1D* h7 = (TH1D*)f1->Get(User_ID+"/ClosureTest/MET_OS_CFweighted_shifted_13");
