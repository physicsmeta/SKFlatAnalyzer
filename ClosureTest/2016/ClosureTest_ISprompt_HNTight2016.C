void ClosureTest_ISprompt_HNTight2016(){
...
TCanvas* c1 = new TCanvas("c1","ZMass : OS_CFweighted_1.2% vs SS_prompt ("+User_ID+")",1000,100,900,800);
c1->Divide(1,2);
...
gr1->SetLineColor(15);
gr1->SetTitle("ZMass : OS_CFweighted_1.2% vs SS_prompt ("+User_ID+")");
...
legend->AddEntry(gr1,"OS_CFweighted_1.2%","lp");
...
TCanvas* c3 = new TCanvas("c3","pt1 : OS_shifted_1.2% vs SS_prompt ("+User_ID+")",100,100,900,800);
c3->Divide(1,2);
...
pt1_SS->SetTitle("pt1 : OS_CFweighted_1.2% vs SS_prompt ("+User_ID+")");
...
legend_pt1->AddEntry(pt1_OS,"OS_CFweighted_1.2%","lp");
...
TCanvas* c4 = new TCanvas("c4","pt2 : OS_shifted_1.2% vs SS_prompt ("+User_ID+")",100,100,900,800);
c4->Divide(1,2);
...
pt2_SS->SetTitle("pt2 : OS_CFweighted_1.2% vs SS_prompt ("+User_ID+")");
//pt1->GetXaxis()->SetRangeUser(70,110);
//pt1->SetMinimum(0.);
...
legend_pt2->AddEntry(pt2_OS,"OS_CFweighted_1.2%","lp");
...
TCanvas* c5 = new TCanvas("c5","MET : OS_shifted_1.2% vs SS_prompt ("+User_ID+")",100,100,900,800);
c5->Divide(1,2);
...
MET_SS->SetTitle("MET : OS_CFweighted_1.2% vs SS_prompt ("+User_ID+")");
//pt1->GetXaxis()->SetRangeUser(70,110);
//pt1->SetMinimum(0.);
...
legend_MET->AddEntry(MET_OS,"OS_CFweighted_1.2%","lp");
