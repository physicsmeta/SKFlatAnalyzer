...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  //TH1D* h1 = (TH1D*)f1->Get("HNTight2016/CFrate/EtaRegion1_Denom");
  //TH1D* h2 = (TH1D*)f1->Get("HNTight2016/CFrate/EtaRegion1_Num");
  //TH1D* h3 = (TH1D*)f1->Get("HNTight2016/CFrate/EtaRegion2_Denom");
  //TH1D* h4 = (TH1D*)f1->Get("HNTight2016/CFrate/EtaRegion2_Num");
  //TH1D* h5 = (TH1D*)f1->Get("HNTight2016/CFrate/EtaRegion3_Denom");
  //TH1D* h6 = (TH1D*)f1->Get("HNTight2016/CFrate/EtaRegion3_Num");
