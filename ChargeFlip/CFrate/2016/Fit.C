...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  vector<double> gr2_range = {0, 0.004, 0.02, 0.04};
  ...
  if(save == "y"){
    if(zoom == "y"){
      c1->SaveAs(samplename+"/Fit/"+fit+"_Zoom_EtaRegion1.png");
      c2->SaveAs(samplename+"/Fit/"+fit+"_Zoom_EtaRegion2.png");
      c3->SaveAs(samplename+"/Fit/"+fit+"_Zoom_EtaRegion3.png");
    }
    else{
      c1->SaveAs(samplename+"/Fit/"+fit+"_EtaRegion1.png");
      c2->SaveAs(samplename+"/Fit/"+fit+"_EtaRegion2.png");
      c3->SaveAs(samplename+"/Fit/"+fit+"_EtaRegion3.png");
    }
  }
