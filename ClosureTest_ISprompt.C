...
TCanvas* c1 = new TCanvas("c1","ZMass : OS_CFweighted_1.3% vs SS (prompt)",1000,100,900,800);
c1->Divide(1,2);
...
gr1->SetLineColor(15);
gr1->SetTitle("ZMass : OS_CFweighted_1.3% vs SS (prompt)");
...
legend->AddEntry(gr2,"SS (prompt)","lp");
legend->Draw();
...
gr3->GetYaxis()->SetTitle("#scale[2.2]{SS (prompt) / OS}");
...
TCanvas* c2 = new TCanvas("c2","ZMass : OS_CFweighted vs SS (prompt)",100,100,900,800);
c2->Divide(1,2);
...
//GR1->SetMarkerColor(kMagenta+2);
GR1->SetLineColor(15);
GR1->SetTitle("ZMass : OS_CFweighted vs SS (prompt)");
//GR1->GetXaxis()->SetRangeUser(70,110);
//GR1->SetMinimum(0.);
GR1->Draw("ZAP"); // Z : do not draw small horizontal/vertical lines the end of the error bars
GR1->GetXaxis()->SetTickLength(0.025);
...
legend_2->AddEntry(GR2,"SS (prompt)","lp");
legend_2->Draw();
...
TCanvas* c3 = new TCanvas("c3","pt1 : OS_shifted_1.3% vs SS (prompt)",100,100,900,800);
c3->Divide(1,2);
...
pt1_SS->SetTitle("pt1 : OS_CFweighted_1.3% vs SS (prompt)");
...
legend_pt1->AddEntry(pt1_SS,"SS (prompt)","lp");
legend_pt1->Draw();
...
pt1_R->GetYaxis()->SetTitle("#scale[2.2]{SS (prompt) / OS}");
...
TCanvas* c4 = new TCanvas("c4","pt2 : OS_shifted_1.3% vs SS (prompt)",100,100,900,800);
c4->Divide(1,2);
...
pt2_SS->SetTitle("pt2 : OS_CFweighted_1.3% vs SS (prompt)");
//pt1->GetXaxis()->SetRangeUser(70,110);
//pt1->SetMinimum(0.);
...
legend_pt2->AddEntry(pt2_SS,"SS (prompt)","lp");
legend_pt2->Draw();
...
pt2_R->GetYaxis()->SetTitle("#scale[2.2]{SS (prompt) / OS}");
...
TCanvas* c5 = new TCanvas("c5","MET : OS_shifted_1.3% vs SS (prompt)",100,100,900,800);
c5->Divide(1,2);
...
MET_SS->SetTitle("MET : OS_CFweighted_1.3% vs SS (prompt)");
//pt1->GetXaxis()->SetRangeUser(70,110);
//pt1->SetMinimum(0.);
...
legend_MET->AddEntry(MET_SS,"SS (prompt)","lp");
legend_MET->Draw();
...
MET_R->GetYaxis()->SetTitle("#scale[2.2]{SS (prompt) / OS}");
