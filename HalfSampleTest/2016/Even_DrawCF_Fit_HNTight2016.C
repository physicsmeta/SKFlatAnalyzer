...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  TF1 *gr3_fit2 = new TF1("gr3_fit2","pol1",0.01,0.019);
  ...
  //TGraphErrors *gr3_fit2_err = new TGraphErrors(19);
  //for(int i=0; i<19; i++) gr3_fit2_err->SetPoint(i,0.01+0.0005*i,0);
  ...
  //TGraphErrors *gr3_fit3_err = new TGraphErrors(44);
  //for(int i=0; i<44; i++) gr3_fit3_err->SetPoint(i,0.019+0.0005*i,0);
