...
for(unsigned int i=0; i<User_ID.size(); i++){
  ...
  TF1 *gr1_fit1 = new TF1("gr1_fit1","pol1",0,0.005);
  TF1 *gr1_fit2 = new TF1("gr1_fit2","pol1",0.005,0.0155);
  ...
  TGraphErrors *gr1_fit1_err = new TGraphErrors(6);
  for(int i=0; i<6; i++) gr1_fit1_err->SetPoint(i,0.001*i,0);
  ...
  TGraphErrors *gr1_fit2_err = new TGraphErrors(22);
  for(int i=0; i<22; i++) gr1_fit2_err->SetPoint(i,0.005+0.0005*i,0);
  ...
  TGraphErrors *gr1_fit3_err = new TGraphErrors(52);
  for(int i=0; i<52; i++) gr1_fit3_err->SetPoint(i,0.0155+0.0005*i,0);
  ...
  TGraphErrors *gr2_fit3_err = new TGraphErrors(52);
  for(int i=0; i<52; i++) gr2_fit3_err->SetPoint(i,0.0155+0.0005*i,0);
  ...
  TF1 *gr3_fit1 = new TF1("gr3_fit1","pol1",0,0.01);
  TF1 *gr3_fit2 = new TF1("gr3_fit2","pol1",0.01,0.0205);
  TF1 *gr3_fit3 = new TF1("gr3_fit3","pol1",0.0205,0.04);
  ...
  TGraphErrors *gr3_fit1_err = new TGraphErrors(21);
  for(int i=0; i<21; i++) gr3_fit1_err->SetPoint(i,0.0005*i,0);
  ...
  TGraphErrors *gr3_fit2_err = new TGraphErrors(22);
  for(int i=0; i<22; i++) gr3_fit2_err->SetPoint(i,0.01+0.0005*i,0);
  ...
  TGraphErrors *gr3_fit3_err = new TGraphErrors(42);
  for(int i=0; i<42; i++) gr3_fit3_err->SetPoint(i,0.0205+0.0005*i,0);
