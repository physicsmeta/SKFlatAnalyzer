...
public:
  ...
  std::vector<Electron> SelectChargeTightElectrons(const std::vector<Electron>& electrons, TString id, double ptmin, double fetamax); //JH : for CF, POG ID + tight charge
