#include "DY_CR_2016H.h"

DY_CR_2016H::DY_CR_2016H(){

}

void DY_CR_2016H::initializeAnalyzer(){
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/DY_CR_2016H.h 
...
void DY_CR_2016H::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/DY_CR_2016H.h,
...
//  AllFatJets = GetAllFatJets();
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/DY_CR_2016H.h
...
void DY_CR_2016H::executeEventFromParameter(AnalyzerParameter param){

  vector<TString> channels = {"dimu", "diel", "emu"};
  vector<TString> regions = {"DY"}; 
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[DY_CR_2016H::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
  ...
  for(unsigned int i=0; i<this_AllJets.size(); i++){
    ...
    //if(fatjet_count > 0) continue; //JH : We won't use fatjet cleaning here
...
//          ele_idsf = mcCorr->ElectronID_SF(param.Electron_ID_SF_Key, electrons.at(j).scEta(), electrons.at(j).Pt(), 0);
        ...
        //} //JH : We won't use fatjet in this CR.
      ...
      /////////////////////////////////////////////////////////
      //// Selection for DY events (triggers have been already applied.)
      /////////////////////////////////////////////////////////
