...
void DY_CR::initializeAnalyzer(){
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/DY_CR.h 
...
void DY_CR::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/DY_CR.h,
...
//  AllFatJets = GetAllFatJets();
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/DY_CR.h
...
void DY_CR::executeEventFromParameter(AnalyzerParameter param){
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[DY_CR::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
