...
void Signal_ee::initializeAnalyzer(){
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/Signal_ee.h 
...
//  cout << "[Signal_ee::initializeAnalyzer] IsoMuTriggerName = " << IsoMuTriggerName << endl;
//  cout << "[Signal_ee::initializeAnalyzer TriggerSafePtCut = " << TriggerSafePtCut << endl;
...
void Signal_ee::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/Signal_ee.h,
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/Signal_ee.h
...
void Signal_ee::executeEventFromParameter(AnalyzerParameter param){
  ...
  // Cutflow : No Cuts
  FillHist("ee/DY/Number_Events_"+IDsuffix, -0.5, weight, cutflow_bin, 0., cutflow_max);
  FillHist("ee/DY/Number_Events_unweighted_"+IDsuffix, -0.5, 1., cutflow_bin, 0., cutflow_max);
  FillHist("ee/Pre/Number_Events_"+IDsuffix, -0.5, weight, cutflow_bin, 0., cutflow_max);
  FillHist("ee/Pre/Number_Events_unweighted_"+IDsuffix, -0.5, 1., cutflow_bin, 0., cutflow_max);
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[Signal_ee::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
