#include "test_2016H.h"

test_2016H::test_2016H(){

}

void test_2016H::initializeAnalyzer(){
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/test_2016H.h 
...
void test_2016H::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/test_2016H.h,
...
//  AllFatJets = GetAllFatJets();
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/test_2016H.h
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[test_2016H::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
