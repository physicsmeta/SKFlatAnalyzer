...
void ttHTobb::initializeAnalyzer(){
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/ttHTobb.h 
...
void ttHTobb::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/ttHTobb.h,
...
//  AllFatJets = GetAllFatJets();
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/ttHTobb.h
...
void ttHTobb::executeEventFromParameter(AnalyzerParameter param){
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[ttHTobb::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
...
//      if( this_discr > mcCorr->GetJetTaggingCutValue(JetTagging::DeepCSV, JetTagging::Medium) ) NBJets_NoSF++;
    ...
    if(mcCorr->IsBTagged_2a(jtp_DeepCSV_Medium, jets_nolepveto.at(ij))){
      Nbjet_medium++; //JH : count Nbjet. NOTE : AN says they used CVSv2 and medium WP.
      bjets.push_back(jets_nolepveto.at(ij));
    }
  }
  std::sort(bjets.begin(), bjets.end(), PtComparing); //JH : sort bjets
...
/////////////////////////////////Draw bjets/////////////////////////////////////////////
FillHist("NBJet", bjets.size(), 1., 10, 0., 10.);
if(bjets.size()>0){
  FillHist("BJet1_Pt", bjets.at(0).Pt(), 1., 1000, 0., 1000.);
  FillHist("BJet1_Eta", bjets.at(0).Eta(), 1., 50, -2.5, 2.5);
  FillHist("BJet1_Phi", bjets.at(0).Phi(), 1., 63, -3.15, 3.15);
  FillHist("BJet1_Energy", bjets.at(0).Energy(), 1., 1000, 0., 1000.);
  FillHist("BJet1_Mass", bjets.at(0).M(), 1., 1000, 0., 1000.);
}
if(bjets.size()>1){
  FillHist("BJet2_Pt", bjets.at(1).Pt(), 1., 1000, 0., 1000.);
  FillHist("BJet2_Eta", bjets.at(1).Eta(), 1., 50, -2.5, 2.5);
  FillHist("BJet2_Phi", bjets.at(1).Phi(), 1., 63, -3.15, 3.15);
  FillHist("BJet2_Energy", bjets.at(1).Energy(), 1., 1000, 0., 1000.);
  FillHist("BJet2_Mass", bjets.at(1).M(), 1., 1000, 0., 1000.);
  FillHist("DiBJet12_Mass", (bjets.at(0)+bjets.at(1)).M(), 1., 1000, 0., 1000.);
}
if(bjets.size()>2){
  FillHist("BJet3_Pt", bjets.at(2).Pt(), 1., 1000, 0., 1000.);
  FillHist("BJet3_Eta", bjets.at(2).Eta(), 1., 50, -2.5, 2.5);
  FillHist("BJet3_Phi", bjets.at(2).Phi(), 1., 63, -3.15, 3.15);
  FillHist("BJet3_Energy", bjets.at(2).Energy(), 1., 1000, 0., 1000.);
  FillHist("BJet3_Mass", bjets.at(2).M(), 1., 1000, 0., 1000.);
  FillHist("DiBJet13_Mass", (bjets.at(0)+bjets.at(2)).M(), 1., 1000, 0., 1000.);
  FillHist("DiBJet23_Mass", (bjets.at(1)+bjets.at(2)).M(), 1., 1000, 0., 1000.);
}
if(bjets.size()>3){
  FillHist("BJet4_Pt", bjets.at(3).Pt(), 1., 1000, 0., 1000.);
  FillHist("BJet4_Eta", bjets.at(3).Eta(), 1., 50, -2.5, 2.5);
  FillHist("BJet4_Phi", bjets.at(3).Phi(), 1., 63, -3.15, 3.15);
  FillHist("BJet4_Energy", bjets.at(3).Energy(), 1., 1000, 0., 1000.);
  FillHist("BJet4_Mass", bjets.at(3).M(), 1., 1000, 0., 1000.);
  FillHist("DiBJet14_Mass", (bjets.at(0)+bjets.at(3)).M(), 1., 1000, 0., 1000.);
  FillHist("DiBJet24_Mass", (bjets.at(1)+bjets.at(3)).M(), 1., 1000, 0., 1000.);
  FillHist("DiBJet34_Mass", (bjets.at(2)+bjets.at(3)).M(), 1., 1000, 0., 1000.);
}
for(int i=0; i<gens.size(); i++){
  if(gens.at(i).PID()==25){
    FillHist("H_Mass", gens.at(i).M(), 1., 1000, 0., 1000.);
  }
}
