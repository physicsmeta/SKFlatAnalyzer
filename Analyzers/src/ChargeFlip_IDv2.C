#include "ChargeFlip_IDv2.h" 

ChargeFlip_IDv2::ChargeFlip_IDv2(){

}

void ChargeFlip_IDv2::initializeAnalyzer(){
...
void ChargeFlip_IDv2::executeEvent(Long64_t Nentry){
...
void ChargeFlip_IDv2::executeEventFromParameter(AnalyzerParameter param, Long64_t Nentry){
...
double ChargeFlip_IDv2::GetCFweight(std::vector<Electron> eles, TString id){
...
double ChargeFlip_IDv2::GetCFweight_SF(std::vector<Electron> eles, TString id){
...
double ChargeFlip_IDv2::GetHalfSampleWeight(const Electron& electron, TString id){;
