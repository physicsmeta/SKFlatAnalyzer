#include "Control_rep_2016H.h"

Control_rep_2016H::Control_rep_2016H(){

}

void Control_rep_2016H::initializeAnalyzer(){

  //==== if you use "--userflags RunSyst" with SKFlat.py, HasFlag("RunSyst") will return "true"
//  RunSyst = HasFlag("RunSyst");
//  cout << "[Control_rep_2016H::initializeAnalyzer] RunSyst = " << RunSyst << endl;
  ...
  //==== I defined "TString IsoMuTriggerName;" and "double TriggerSafePtCut;" in Analyzers/include/Control_rep_2016H.h 
...
//  cout << "[Control_rep_2016H::initializeAnalyzer] IsoMuTriggerName = " << IsoMuTriggerName << endl;
//  cout << "[Control_rep_2016H::initializeAnalyzer TriggerSafePtCut = " << TriggerSafePtCut << endl;
...
void Control_rep_2016H::executeEvent(){
  ...
  //==== So, I defined "vector<Muon> AllMuons;" in Analyzers/include/Control_rep_2016H.h,
...
//  AllFatJets = GetAllFatJets();
  ...
  //==== I defined "double weight_Prefire;" in Analyzers/include/Control_rep_2016H.h
...
void Control_rep_2016H::executeEventFromParameter(AnalyzerParameter param){
...
/*  if(param.syst_ == AnalyzerParameter::Central){
    ...
    cout << "[Control_rep_2016H::executeEventFromParameter] Wrong syst" << endl;
    exit(EXIT_FAILURE);
  }*/
...
//  FillHist("Nbjet_medium_"+IDsuffix, Nbjet_medium, weight, 5, 0., 5.);
  ...
  FillHist("WZ/MET_First_"+IDsuffix, METv.Pt(), weight, 1000, 0., 1000.); //JH
  METv = UpdateMETMuon(METv, muons);
  METv = UpdateMETElectron(METv, electrons);
  double MET = METv.Pt(); // JH : MET propagated
  FillHist("WZ/MET_Second_"+IDsuffix, METv.Pt(), weight, 1000, 0., 1000.); //JH
