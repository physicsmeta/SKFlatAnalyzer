...
python python/SKFlat.py -a ChargeFlip -y 2016 -i DYJets_Pt-100To250 -n 100 --userflags CFrate &
python python/SKFlat.py -a ChargeFlip -y 2016 -i DYJets_Pt-250To400 -n 100 --userflags CFrate &
python python/SKFlat.py -a ChargeFlip -y 2016 -i DYJets_Pt-400To650 -n 100 --userflags CFrate &
python python/SKFlat.py -a ChargeFlip -y 2016 -i DYJets_Pt-650ToInf -n 100 --userflags CFrate &
